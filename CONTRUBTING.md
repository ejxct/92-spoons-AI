Contributing to 92 Spoons AI
============================

The 92 Spoons AI project operates an open contributor model where anyone is welcome to contribute towards development in the form of peer review, testing and patches. This document explains the practical process and guidelines for contributing.
...
The following applies to code changes to the 92 Spoons AI project.

Whether a pull request is merged into 92 Spoons AI rests with the project merge maintainers and ultimately the project lead.
...
The project leader is the release manager for each 92 Spoons AI release.
